...
import { HashRouter as Router, Routes, Route, Navigate } from './lib/cms';
...
// Extension Centres Dedicated Pages
          ...
          <Layout>
            <Suspense fallback={<SkeletonPage />}>
              <Routes>
                ...
                {/* --- INFO & EXTENSIONS --- */}
                <Route path="/whos-who" element={<TeamPage />} />
                ...
                {/* --- CERTIFICATES --- */}
                <Route path="/ISO-9001-2015-Certificate" element={<CertificatePage />} />
                <Route path="/ISO-AS9100-2016" element={<CertificatePage />} />
                <Route path="/NABL-Certificate" element={<CertificatePage />} />
                <Route path="/ISO-IEC" element={<CertificatePage />} />
                <Route path="/ISO-AS9100" element={<CertificatePage />} />
                <Route path="/iso" element={<CertificatePage />} />
                <Route path="/nabl-certificate" element={<CertificatePage />} />
